...
export async function POST(request: NextRequest) {
    ...
    try {
        ...
        // Check file size (10MB limit for Aspose)
        ...
        // Upload document with Aspose conversion
                ...
                const uploadStream = cloudinary.uploader.upload_stream(
                    {
                        ...
                        raw_convert: "aspose", // Enable Aspose conversion
        ...
        return NextResponse.json({
            ...document,
            originalUrl: cloudinary.url(uploadResult.public_id, { resource_type: "raw" }),
            message: "Document uploaded successfully. PDF conversion in progress..."
        });
