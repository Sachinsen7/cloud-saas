...
import { Upload, Video as VideoIcon, Wand2, Image, FileText as FileTextIcon, Brain as BrainIcon } from "lucide-react";
    ...
    <div className="container mx-auto p-4 max-w-7xl">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600 mb-8">
          Upload, process, and transform your media with powerful AI tools
        </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div className="stat bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-2xl">
          ...
          <div className="stat-desc text-blue-200">Uploaded and processed</div>
        </div>
        ...
        <div className="stat bg-gradient-to-r from-purple-500 to-purple-600 text-white rounded-2xl">
          ...
          <div className="stat-title text-purple-100">AI Features</div>
          <div className="stat-value">8</div>
          <div className="stat-desc text-purple-200">Advanced AI tools available</div>
        </div>
        ...
        <div className="stat bg-gradient-to-r from-teal-500 to-teal-600 text-white rounded-2xl">
          ...
          <div className="stat-title text-teal-100">Document Formats</div>
          <div className="stat-value">12</div>
          <div className="stat-desc text-teal-200">Office formats supported</div>
        </div>
        ...
        <div className="stat bg-gradient-to-r from-green-500 to-green-600 text-white rounded-2xl">
          ...
          <div className="stat-title text-green-100">Social Formats</div>
          <div className="stat-value">5</div>
          <div className="stat-desc text-green-200">Social media formats supported</div>
        </div>
      </div>
    </div>
  );
